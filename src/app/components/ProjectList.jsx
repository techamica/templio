...
export default function ProjectList() {
    return <motion.div
        ...
        className="relative z-10 w-full xl:w-[50%] h-60 rounded-lg sm:h-80 md:h-[320px] lg:h-[360px] xl:h-[400px] order-1 xl:order-none xl:mt-0"
    >
        <Swiper
            spaceBetween={30}
            slidesPerView={1}
            className="w-full h-60 rounded-lg sm:h-80 md:h-[320px] lg:h-[360px] xl:h-[400px] order-1 xl:order-none xl:mt-0 shadow-md shadow-white/30"
